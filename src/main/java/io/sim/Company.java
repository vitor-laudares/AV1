...
public class Company extends Thread {
    ...
    public Company(double saldoInicial) {
    ...
    public void pagarMotoristas(double valorPorKm, int quilometros, Driver driver) {
        double pagamento = valorPorKm * quilometros;
        Transacao transacao = new Transacao(pagamento, conta, driver.getContaCorrente());
        transacao.executar();
    }
